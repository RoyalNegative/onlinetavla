...
import type { Action, BattleshipView, DamaView, DortluView, MangalaView, TavlaView } from '@tavla/engine';
...
export interface RoomUpdate {
  ...
  view: TavlaView | DamaView | BattleshipView | MangalaView | DortluView;
  room: RoomSnapshot;
}
